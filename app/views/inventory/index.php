                        ...
                        <tr style="<?php echo $isCritical ? 'background: rgba(239, 68, 68, 0.03);' : ''; ?>">
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href="<?php echo BASE_URL; ?>/inventario/eliminar/<?php echo $i['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de desactivar y dar de baja (lógicamente) a este artículo?')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
