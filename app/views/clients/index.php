                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <form action="<?php echo BASE_URL; ?>/clientes/eliminar/<?php echo $c['id']; ?>" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de desactivar y dar de baja (lógicamente) a este cliente?')">
